    ...
    <Container>
      <div className="product-wrape mb-60">
        <h2 className="main-title" data-aos="fade-down" data-aos-once="true">
          {pathname === "/shop" ? "Shop" : "Products"}{" "}
          <span className="show-result">({items?.length})</span>
        </h2>
        <Row>
          <Col sm={12} md={3} lg={3}>
            <ProductSidebar
              filterPriceData={priceFilterData}
              handleFilterByRating={filterByRating}
              currency_code={items?.[0]?.price?.[0]?.country?.currency}
              categoriesList={categoriesData}
              filterCategoryData={categoryFilterData}
            ...
            >
              <Form.Check
                ...
                onChange={(e) => {
                  ...
                  filterSaleProduct(e.target.checked);
                }}
              />
